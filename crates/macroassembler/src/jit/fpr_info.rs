...
cfg_if! {
    if #[cfg(target_arch="x86_64")] {
        ...
        pub const NUMBER_OF_FP_REGISTERS: usize = 6;
        pub const NUMBER_OF_FP_ARGUMENT_REGISTERS: usize = 8;
        ...
        pub const FP_ARGUMENT_REGISTERS: &[u8] = &[ARGUMENT_FPR0, ARGUMENT_FPR1, ARGUMENT_FPR2, ARGUMENT_FPR3, ARGUMENT_FPR4, ARGUMENT_FPR5, ARGUMENT_FPR6, ARGUMENT_FPR7];

        pub const RETURN_VALUE_FPR: u8 = xmm0;

        pub const RETURN_VALUE_FPRS: &[u8] = &[xmm0, xmm1];
