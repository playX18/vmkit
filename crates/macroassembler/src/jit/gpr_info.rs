...
cfg_if! {
    if #[cfg(target_arch="x86_64")]
    {
        ...
        cfg_if! {
            ...
            cfg_if! {
                if #[cfg(not(windows))] {
                    ...
                    pub const CALLEE_SAVE_REGISTERS: &[u8] = &[CS0, CS1, CS2, CS3, CS4];
                } else {
                    ...
                    pub const CALLEE_SAVE_REGISTERS: &[u8] = &[CS0, CS1, CS2, CS3, CS4, CS5, CS6];
                }
            }
            ...
            cfg_if! {
                if #[cfg(not(windows))] {
                    ...
                    pub const ARGUMENT_REGISTERS: &[u8] = &[ARGUMENT_GPR0, ARGUMENT_GPR1, ARGUMENT_GPR2, ARGUMENT_GPR3, ARGUMENT_GPR4, ARGUMENT_GPR5];
                } else {
                    ...
                    pub const ARGUMENT_REGISTERS: &[u8] = &[ARGUMENT_GPR0, ARGUMENT_GPR1, ARGUMENT_GPR2, ARGUMENT_GPR3];
                }
            }
        ...
        pub const CALLEE_SAVE_REGISTERS: &[u8] = &[CS0, CS1, CS2, CS3, CS4, CS5, CS6, CS7, CS8, CS9, CS10];
        ...
        pub const CALLEE_SAVE_REGISTERS: &[u8] = &[CS0, CS1, CS2, CS3, CS4, CS5, CS6, CS7, CS8, CS9];
        ...
        pub const ARGUMENT_REGISTERS: &[u8] = &[ARGUMENT_GPR0, ARGUMENT_GPR1, ARGUMENT_GPR2, ARGUMENT_GPR3, ARGUMENT_GPR4, ARGUMENT_GPR5, ARGUMENT_GPR6, ARGUMENT_GPR7];
